                                                    ...
                                                    {{-- <form id="logdata">
                                                        <div class="buttons">
                                                            ...
                                                            <input type="hidden" name="productname" id="pname"
                                                                value="<?php echo $yfet['productname']; ?>">
                                                            <input type="hidden" name="productcode" id="pcode"
                                                                value="<?php echo $yfet['productcode']; ?>">
                                                            <input type="hidden" name="productunitprice" id="pprice"
                                                                value="<?php echo $yfet['productunitprice']; ?>">
                                                            <input type="hidden" name="picture" id="ppic"
                                                                value="<?php echo $yfet['picture']; ?>">
